"""
compare_models.py — run the same document through two models and compare them.
Measures latency, JSON validity, and output for each model.
Produces the "findings and recommendations" the assignment asks for.
"""
...
if __name__ == "__main__":
    models_to_compare = [config.HAIKU_MODEL, config.SONNET_MODEL]
    results = compare(config.BUCKET_NAME, "claims/claim1.txt", models_to_compare)
